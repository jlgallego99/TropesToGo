...
nuevo objeto Media, no se persiste directamente, sino que se almacena en un
vector de objetos Media como parte del objeto \textit{scraper}. Este vector se
va rellenando con las sucesivas llamadas de añadir Media, hasta que finalmente
...
intermedia el objeto Media al vector en memoria, comprobando previamente que no
