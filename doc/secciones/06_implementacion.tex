...
obtener el conjunto de datos lo antes posible, de forma personalizable, y sin
tener que aprender comandos o cómo utilizar el programa; simplemente deberán
seguir paso a paso lo que les dicte el programa. Todo ello debe además ser lo
suficientemente vistoso y usable, de forma que el usuario pueda interactuar con
el programa escribiendo o manejando opciones con las flechas del teclado.
...
que se utiliza para las aplicaciones CLI de proyectos tan conocidos como
...
proporciona un API sencillo que se adapta bien a las necesidades de la
...
tiene algunas funcionalidades para retocar el aspecto del interfaz que no son
necesarias, ya que buscamos una opción simple pero efectiva.

Promptui, pese a no estar actualizada, es estable y es una opción más que
...
últimas semanas. Tiene un API muy parecido al de Promptui, pero con la ventaja
...
Una vez definidas todas las entradas del usuario, que se guardan en variables,
...
primero crear el \textit{crawler} y llamar a la función principal que encuentra
...
obtiene un objeto TvTropesPages con el resultado completo del \textit{crawling}
sobre TvTropes. A continuación se configura un repositorio u otro según lo que
ha elegido el usuario, y se crea el servicio \textit{scraper} inyectando esta
...
% Para simplificar solo se utilizaran dos niveles de logging imprescindibles INFO, en verde indicando que todo esta bien, y ERROR en rojo indicando que no
