...
solamente extrae los que están en la sección principal, ignorando las sub wikis.
...
posible y pudiendo elegir no tener la totalidad de los datos existentes, se
permite limitar el proceso de \textit{crawling} a un número de obras limitado en
lugar de encontrarlas todas.

\subsubsection{Reutilización de páginas extraídas}
Usar punteros a los documentos \textit{Goquery}.
