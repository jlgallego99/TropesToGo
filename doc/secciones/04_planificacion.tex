...
pretenden alcanzar consecutivamente. Finalmente se estudiarán y justificarán una
serie de buenas prácticas y herramientas que se seguirán al escribir el código y
testearlo para asegurar la calidad y desarrollar correctamente el
\textit{software}.
...
se busca un lenguaje de programación que se bastante afín a trabajar con el
protocolo HTTP, sea rápido y compilado para poder gestionar el gran volúmen de
datos que se tratará y además sea concurrente para intentar mejorar el ritmo de
las peticiones del \textit{crawler}, como se comentó en el estado del arte.
...
código. Usar un buen entorno que ayude en el proceso de construcción del
...
satisfechos con Go y el 75\% lo usaban en el trabajo, qué entornos de desarrollo
eran los preferidos por la comunidad. Los dos entornos principalmente usados son
los propios que se recomiendan oficialmente, VS Code y GoLand, siendo VS Code el
más utilizado con diferencia, lo cual es comprensible puesto que es una opción
gratuita y muy utilizada en todos los ámbitos, sin embargo, GoLand pese a ser de
pago se sigue utilizando bastante y demuestra la popularidad de la herramienta.

De entre estas dos alternativas se decide usar GoLand. Su principal ventaja es
que, a diferencia de VS Code, el cual usa un plugin, GoLand es un IDE
enteramente dedicado a Go y tiene funcionalidades más avanzadas debido a que es
un entorno de desarrollo más potente, con mayores funcionalidades y que nos
permite centrarnos en el desarrollo de un sólo lenguaje. Además de esto, también
se prefiere GoLand desde el punto de vista educativo, ya que, tiene interés
aprender a utilizar una herramienta oficial centrada en un lenguaje y la
Universidad de Granada ofrece una licencia gratuita para todos los productos de
JetBrains, incluido GoLand, por lo que el precio no supone un problema. GoLand
es una herramienta pensada para proyectos más grandes como este y permitirá
facilitar el desarrollo gracias a las múltiples funciones que tiene, como
autocompletar o refactorizar el código, que hace mucho más fácil implementar
cambios en un ambiente ágil como el que nos encontramos.
