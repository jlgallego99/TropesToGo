...
etiqueta \texttt{<hr>} que pone una línea horizontal y un título de sección \texttt{<h2>} en el que, como se vio en \cite{nishalscraping}, varía el texto,
aunque es bastante frecuente que contenga las palabras
