...
siguiente capítulo conociendo todas las características de la web.
...
del tropo en estilo \textit{CamelCase}. Sin embargo, esto es relevante solo para
entender cuando una página es un \textit{tropo}, no para encontrarlos. Antes se
necesita saber cuáles existen y sus nombres.
